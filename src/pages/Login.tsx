...
const Login = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log(
        "Login function completed, isAuthenticated should update soon"
      );
  ...
  const createDemoUsers = async () => {
    ...
    try {
      ...
      // Create editor user
      const { data: editorData, error: editorError } =
      ...
      toast.success(
        "Demo users created! Check emails for confirmation links or disable email verification in Supabase dashboard."
      );
