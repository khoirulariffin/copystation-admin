          ...
          <div className="flex justify-between items-center">
            ...
            <div className="hidden md:flex md:items-center md:space-x-8">
              ...
              <Button asChild variant="outline" className={cn(
                ...
                !scrolled && "border-white text-white hover:bg-white/10 hover:text-white"
              )}>
                <Link to="/login">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                <li><Link to="/products?category=Paper" className="hover:text-primary transition-colors">Paper</Link></li>
                <li><Link to="/products?category=Stationery" className="hover:text-primary transition-colors">Stationery</Link></li>
                <li><Link to="/products?category=Office Supplies" className="hover:text-primary transition-colors">Office Supplies</Link></li>
                <li><Link to="/products?category=Printing Services" className="hover:text-primary transition-colors">Printing Services</Link></li>
              </ul>
            </div>
            <div>
          ...
          <div className="mt-8 pt-8 border-t border-gray-800 text-center text-sm text-gray-400">
            <p>&copy; {new Date().getFullYear()} CopyStation. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
